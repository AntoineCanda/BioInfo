...
echo
$bioseq "ratio-common-spaced-kmers" "####-####" ebola-z-mutated-0.fasta $FILE2
echo 
echo "Test avec graine ######## et 0 mutation"
echo
$bioseq "ratio-common-spaced-kmers" "########" ebola-z-mutated-0.fasta $FILE2
...
echo
$bioseq "ratio-common-spaced-kmers" "####-####" ebola-z-mutated-10.fasta $FILE2
echo 
echo "Test avec graine ######## et 10 mutations"
echo
$bioseq "ratio-common-spaced-kmers" "########" ebola-z-mutated-10.fasta $FILE2
...
echo
$bioseq "ratio-common-spaced-kmers" "####-####" ebola-z-mutated-100.fasta $FILE2
echo 
...
echo
$bioseq "ratio-common-spaced-kmers" "####-####" ebola-z-mutated-1000.fasta $FILE2
echo 
...
echo
$bioseq "ratio-common-spaced-kmers" "########" ebola-z-mutated-10000.fasta $FILE2
echo 
